...
public class DoctorResource {
	...
	//Get specific Doctor information returned as a text/plain response.
	...
	//
	//GET doctor by lastName in text 
	...
	//GET doctor by lastName in JSON 
	...
	//GET doctor by Hospital id in TEXT 
	
	@GET
    @Produces(MediaType.TEXT_PLAIN)
    @Path("hospital/{id}")
    public String getDoctorsByHospital(@PathParam("id") String id) {
        System.out.println("GET all Doctors by specialization (text): " + id);
        String result = "";
	...
	//GET doctor by Hospital id in JSON
    ...
    public Doctor[] getDoctorsByHospitalJSON(@PathParam("id") String id) {
        System.out.println("GET all Doctors by specialization (JSON): " + id);
        ArrayList<Doctor> matches = new ArrayList<Doctor>();
